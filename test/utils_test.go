...
var LocalIPAddr = "124.220.156.104"
var serverAddr = "http://" + LocalIPAddr + ":8005" // 服务器地址

// newExpect 创建一个 httpexpect.Expect 对象，用于http请求和断言
...
// getTestUserIdAndToken 获取测试用户的id和token
