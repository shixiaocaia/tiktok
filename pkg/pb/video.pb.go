...
func (x *PublishVideoResponse) GetCommonRsp() *CommonResponse {
	if x != nil {
		return x.CommonRsp
	}
	return nil
...
var file_video_proto_rawDesc = []byte{
	...
	0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x46, 0x0a, 0x14, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73,
	0x68, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2e,
	...
	0x6e, 0x73, 0x65, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x73, 0x70, 0x22, 0x58,
...
var file_video_proto_depIdxs = []int32{
	...
	15, // 4: PublishVideoResponse.common_rsp:type_name -> CommonResponse
	12, // 5: GetFeedListResponse.video_list:type_name -> VideoInfo
	12, // 6: GetVideoInfoListRsp.video_info_list:type_name -> VideoInfo
	6,  // 7: VideoService.GetPublishVideoList:input_type -> GetPublishVideoListRequest
	8,  // 8: VideoService.PublishVideo:input_type -> PublishVideoRequest
	10, // 9: VideoService.GetFeedList:input_type -> GetFeedListRequest
	13, // 10: VideoService.GetVideoInfoList:input_type -> GetVideoInfoListReq
	4,  // 11: VideoService.GetFavoriteVideoList:input_type -> GetFavoriteVideoListReq
	0,  // 12: VideoService.UpdateFavoriteCount:input_type -> UpdateFavoriteCountReq
	2,  // 13: VideoService.UpdateCommentCount:input_type -> UpdateCommentCountReq
	7,  // 14: VideoService.GetPublishVideoList:output_type -> GetPublishVideoListResponse
	9,  // 15: VideoService.PublishVideo:output_type -> PublishVideoResponse
	11, // 16: VideoService.GetFeedList:output_type -> GetFeedListResponse
	14, // 17: VideoService.GetVideoInfoList:output_type -> GetVideoInfoListRsp
	5,  // 18: VideoService.GetFavoriteVideoList:output_type -> GetFavoriteVideoListRsp
	1,  // 19: VideoService.UpdateFavoriteCount:output_type -> UpdateFavoriteCountRsp
	3,  // 20: VideoService.UpdateCommentCount:output_type -> UpdateCommentCountRsp
